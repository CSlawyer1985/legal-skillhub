...
**2303 个法律 Agent Skill 的目录 · 说明书 · 分类体系 · 部署入口**

[![License](https://img.shields.io/badge/License-See%20individual%20skills-blue.svg)]()
[![Skills](https://img.shields.io/badge/Skills-2303-brightgreen.svg)](index/master-index.md)
...
**Legal SkillHub** 是一个面向法律人的 Agent Skill 聚合与学习平台。它将 2303 个法律 AI Skill 从公开数据与获授权的本地材料中整理收录，为每一份 Skill 提供：
...
💡 **目录** - 2303 个法律 Skill 全量收录，8 维标签体系（法域/领域/任务/角色/语言/授权/类型/自动化等级）多维筛选
...
- **🗂️ Skill 总数**：2303 个
- **🌏 法域覆盖**：中国大陆 1039 / 美国 655 / 法域中立 411 / 欧盟 147 / 跨境国际 78 / 法国 30 等
- **📚 语言分布**：中文 1251 / 英文 1052
- **🏷️ 标签维度**：8 维主分类 + 9 维高级筛选（法域/领域/任务/角色/行业/输入/输出/授权/风险等）
- **📁 文件规模**：15,234 个可索引文件，约 200MB（无单文件 >5MB，GitHub 友好）
- **🛠️ 技能形态**：指令型 1573 / 代码包型 217 / 知识包型 191 / 混合型 195 / 工具封装型 113 / 模板型 14
...
```
├── skills/              # 2303 个 Skill 本体（每个一个文件夹：SKILL.md + 附属文件）
├── index/               # 索引区（建站基础）
