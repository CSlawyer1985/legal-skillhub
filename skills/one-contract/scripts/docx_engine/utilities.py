...
class XMLEditor:
    ...
    Attributes:
        ...
        encoding: Serialization encoding. Candidate outputs are normalized to UTF-8.
    ...
    def __init__(self, xml_path):
        ...
        # OOXML consumers are inconsistent about Python/minidom's ASCII output
        # with numeric character references. Normalize every edited part to
        # explicit UTF-8 and let the package quality gate reject regressions.
        self.encoding = "utf-8"
    ...
    def save(self):
        ...
        Serializes the DOM tree as UTF-8 and writes it back to the original path.
        """
