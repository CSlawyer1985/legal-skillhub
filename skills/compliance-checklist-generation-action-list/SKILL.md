---
name: compliance-checklist-generation-action-list
slug: compliance-checklist-generation-action-list
version: 1.0.2
displayName: "合规框架检查清单生成｜简诗 AI"
summary: "为SOC2、HIPAA、PCI-DSS和GDPR等主要合规框架生成结构化检查清单，映射控制项与要求，评估准备度并输出优先修复计划。"
description: "为SOC2、HIPAA、PCI-DSS和GDPR等主要合规框架生成结构化检查清单，映射控制项与要求，评估准备度并输出优先修复计划。"
