...
slug: patent-lawyer-agent
version: 1.0.1
displayName: "专利申请分析与撰写｜简诗 AI"
summary: "提供知识产权指导和专利分析，辅助撰写专利申请文件。非法律建议，需咨询持证专利律师。"
description: "提供知识产权指导和专利分析，辅助撰写专利申请文件。非法律建议，需咨询持证专利律师。"
tags: ["office-productivity", "jianshi-ai"]
---
# Patent Lawyer Agent
