...
```html
<div class="page">
    <h1>张某某诉国家知识产权局商标行政纠纷案<br>时间轴图谱</h1>

    <div class="page-header-info">
        案号：(2021)京行终7712号 | 案由：商标行政管理（商标） | 商标号：第22647284号"青岛春江"
    </div>
    ...
    <div class="timeline">
        ...
        <div class="timeline-item phase-apply">
            ...
            <div class="timeline-content">
                ...
                <span class="timeline-title">申请注册"青岛春江"商标</span>
...
```html
<div class="page">
    <h1>张某某诉国家知识产权局商标行政纠纷案<br>事件明细表</h1>

    <div class="page-header-info">
        案号：(2021)京行终7712号 | 商标号：第22647284号
    </div>
...
```html
<div class="page">
    <h1>张某某诉国家知识产权局商标行政纠纷案<br>综合分析</h1>

    <div class="page-header-info">
        案号：(2021)京行终7712号 | 终审判决日期：2021年12月16日
    </div>
    ...
    <div class="two-col">
        <div>
            ...
            <table class="info-table">
                <tbody>
                    <tr><td>案号</td><td>(2021)京行终7712号</td></tr>
                    <!-- 更多信息 -->
                </tbody>
            </table>
        </div>
