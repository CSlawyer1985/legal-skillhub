...
### 6.1 必须可视化的内容
- **系统架构图**：使用 Excalidraw 生成（v3.3 起取代 Mermaid/PlantUML，渲染与避坑见 docx_engineering.md 第二节）
- **实施进度计划**：使用甘特图
- **组织架构图**：项目团队结构
- **流程图**：关键业务流程、施工流程
- **对比表**：技术参数对比、方案对比
...
### 6.2 图表生成方式
通过 `excalidraw-diagram` skill 绘制并导出 PNG 插入 DOCX；端口化布线、中文渲染（rsvg-convert）、自动裁白边等要点见 `docx_engineering.md` 第二节。
