#!/usr/bin/env python3
"""Query the 企业专利信息 without exposing the API key."""
...
API_ENDPOINT = "https://openapi.chinaz.net/v1/1036/patent"
API_KEY_ENV = "CHINAZ_PATENT_API_KEY"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="查询 企业专利信息")
    ...
    request = Request(
        API_ENDPOINT,
        data=form_data,
        headers={"Accept": "application/json", "User-Agent": "company-patent-skill/1.0", "Content-Type": "application/x-www-form-urlencoded"},
        method="POST",
    )
