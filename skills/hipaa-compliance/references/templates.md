...
## 目录
1. [隐私实践通知（NPP）](#1-隐私实践通知npp)
2. [业务伙伴协议（BAA）](#2-业务伙伴协议baa)
3. [HIPAA 隐私政策（内部）](#3-hipaa-隐私政策内部)
4. [HIPAA 授权书](#4-hipaa-授权书)
5. [员工培训确认书](#5-员工培训确认书)
6. [安全事件报告表](#6-安全事件报告表)
7. [违规风险评估模板](#7-违规风险评估模板)
8. [风险分析模板](#8-风险分析模板)
9. [HIPAA 合规检查清单](#9-hipaa-合规检查清单)
...
> 在向任何将代表你方创建、接收、维护或传输 PHI 的供应商/合作伙伴共享 PHI 之前必备。
