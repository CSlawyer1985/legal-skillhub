...
> **适用范围。** 本子词表在单个按语言分类的文件中涵盖两个密切相关的领域：**金融与银行**（主要）和**交易与资本市场**。两者在此合并，因为其词汇高度重叠（债务工具、证券、交易所监管），译者通常需要同时使用两者。两个跨语言的英文参考词表仍分开：分别见 `references/finance-banking.md` 和 `references/trading-capital-markets.md` 文件。

根据翻译经验自动生成。将荷兰语金融、银行和证券法律术语映射为正确的英文对应词。涵盖贷款协议（facility agreements）、担保文件、荷兰担保权益（质押/抵押）、受《金融监管法》（Wft）监管的银行业、反洗钱/了解你的客户（AML/KYC），以及荷兰法下的银团/项目融资概念。
...
| geldleningsovereenkomst | money-loan agreement | 《荷兰民法典》第 7:129 条 |
...
| faciliteit | facility | |
| tranche | tranche | |
| opname / trekking | drawdown / drawing / utilization | |
| opnameverzoek / trekkingsverzoek | utilization request / drawdown request | |
...
| EURIBOR | EURIBOR | |
| risk-free rate (RFR) | risk-free rate / RFR | LIBOR 后转型（€STR、SONIA、SOFR） |
| terugbetaling / aflossing | repayment | |
| vervroegde aflossing | prepayment / early repayment | |
| aflossingsschema | repayment schedule / amortization schedule | |
...
| verzuim / default | default | 交叉引用《荷兰民法典》第 6:81 条的 verzuim（迟延履行）概念 |
...
| security agent / zekerhedenagent | security agent / security trustee | 荷兰担保通常采用平行债务（parallel debt）结构，因为荷兰法不承认信托 |
| arrangeur | arranger | |
...
| contractsoverneming | assumption of contract / novation | 《荷兰民法典》第 6:159 条——需要所有当事人配合 |
...
| pandrecht | right of pledge | 《荷兰民法典》第 3:236 条（占有质）和第 3:237 条（非占有质） |
| vuistpand | possessory pledge | 资产移交给质权人；《荷兰民法典》第 3:236 条 |
| stil pandrecht / bezitloos pandrecht | non-possessory pledge / silent pledge | 《荷兰民法典》第 3:237 条——经登记或公证文书设立；资产仍由出质人持有 |
| openbaar pandrecht | disclosed pledge | 向债务人发出通知（针对债权） |
| eerste pandrecht / tweede pandrecht | first-ranking pledge / second-ranking pledge | |
| verpanding | pledging | |
| pandakte | deed of pledge | |
| hypotheek | mortgage | 针对已登记财产（不动产、船舶、航空器）；《荷兰民法典》第 3:260 条 |
| eerste hypotheek | first-ranking mortgage | |
| bankhypotheek | bank mortgage / all-moneys mortgage | 担保对银行的一切现有和未来债务——荷兰标准做法 |
| krediethypotheek | credit mortgage | 担保特定的信贷关系 |
| vestigen (van een pandrecht/hypotheek) | to create / grant (a pledge / mortgage) | |
| notariële akte | notarial deed | 抵押必需；非占有质建议使用 |
| registratie van pandakte | registration of pledge deed | bezitloos pandrecht 在税务机关登记 |
| executie | enforcement / realization | 违约时出售担保资产 |
| openbare verkoop / executieverkoop | public auction / forced sale | |
| onderhandse verkoop | private sale | 经法院批准（《荷兰民法典》第 3:251 条）或按约定 |
| parate executie | summary enforcement / self-enforcement | 担保债权人可无须判决直接执行 |
| borgtocht | surety / guarantee (personal) | 《荷兰民法典》第 7:850 条——保证人提供的个人保证 |
| particuliere borgtocht | consumer surety | 受《荷兰民法典》第 7:857 条特别形式要求约束 |
| garantie / concerngarantie | guarantee / corporate guarantee / group guarantee | |
| bankgarantie | bank guarantee | 抽象的或附条件的；通常为见索即付 |
...
| intercreditoren overeenkomst | intercreditor agreement / ICA | |
| parallel debt | parallel debt | 荷兰法不承认信托——担保债权人的地位通过向担保代理人设立的平行债务确立 |
| accessoriteit | accessoriness | 荷兰担保具有从属性——依附于被担保债权的存在（因此用平行债务绕开） |
| pluraliteit van rechthebbenden | multiple beneficiaries | 催生平行债务结构的问题 |
...
| bodemrecht (fiscus) | bottom right (tax authority) | 税务机关对债务人场所内“bodem-goederen”（底层资产）的法定留置权——在某些情况下优先于非占有质 |
| bodemvoorrecht / bodemzaakbegrip | bottom privilege / bottom assets | 荷兰特有的税收留置权概念——为外国读者加注说明 |
...
| opschortende voorwaarden voorafgaand aan iedere trekking | conditions precedent to each utilization | |
...
| 荷兰语 | 英语 | 备注 |
|---|---|---|
| Wet op het financieel toezicht (Wft) | Financial Supervision Act | 荷兰核心的审慎与行为监管法规 |
| Besluit prudentieel toezicht financiële groepen Wft | Financial Groups Prudential Supervision Decree | |
| De Nederlandsche Bank (DNB) | Dutch Central Bank | 审慎监管机构（与 AFM 构成双峰模式） |
| Autoriteit Financiële Markten (AFM) | Authority for the Financial Markets | 行为/市场监管机构 |
| vergunning (Wft) | Wft license / authorization | |
...
| geschiktheid en betrouwbaarheid | suitability and integrity | 对高管的适任与诚信测试 |
...
| zorgplicht | duty of care | 荷兰对面向消费者的金融服务提供者施加的更高注意义务 |
| bijzondere zorgplicht | special / enhanced duty of care | 判例法衍生——荷兰最高法院（Hoge Raad）关于咨询和衍生品的判例 |
...
| UBO-register | UBO register | 由 KvK（商会）维护 |
| politically exposed person (PEP) | politically exposed person / PEP | |
| Wwft | AML/CFT Act | 《防止洗钱和恐怖主义融资法》（Wet ter voorkoming van witwassen en financieren van terrorisme） |
| ongebruikelijke transactie | unusual transaction | Wwft 术语——触发向 FIU-Nederland 报告 |
| melding ongebruikelijke transactie | report of unusual transaction | 向 FIU-Nederland（金融情报机构）报告 |
| FIU-Nederland | FIU Netherlands | |
| sanctiewet | Sanctions Act | 《1977 年制裁法》实施联合国/欧盟制裁 |
...
| hoofdelijk en ondeelbaar / hoofdelijk aansprakelijk | jointly and severally / joint and several liability | 《荷兰民法典》第 6:6 条 |
| pari passu | pari passu | |
| gelijke rang | equal ranking / pari passu | |
| toerekening van betalingen | application of payments | |
| compensatie / verrekening | set-off | 《荷兰民法典》第 6:127 条 |
...
| borg | surety | 狭义——《荷兰民法典》第 7:850 条下的个人保证人 |
| regres | recourse / indemnity | |
| subrogatie | subrogation | 《荷兰民法典》第 6:150 条 |

## 破产与重组（金融语境）

| 荷兰语 | 英语 | 备注 |
|---|---|---|
| faillissement | bankruptcy | 适用于公司和自然人 |
...
| rechter-commissaris | supervisory judge | 监督管理人（curator） |
...
| separatist | separatist | 可如同无破产时一样执行的担保债权人——质权人/抵押权人 |
| afkoelingsperiode | cooling-off period | 破产中对执行的短暂中止（2+2 个月） |
| surseance van betaling | suspension of payments | 类似债务人占有（DIP）的中止程序；正被 WHOA 逐步取代 |
| WHOA — Wet homologatie onderhands akkoord | Dutch Scheme | 经法院确认的债务重组方案；可约束异议债权人 |
| akkoord | composition / scheme of arrangement | 破产、停付或 WHOA 程序中 |
| homologatie | court confirmation | |
| herstructurering | restructuring | |
| pre-insolventie akkoord | pre-insolvency composition | |
| paulianeus | fraudulent / avoidable | 《荷兰民法典》第 3:45 条（actio pauliana）和《破产法》第 42 条 |
...
- **Pandrecht**：始终译为“pledge”（质押）——针对动产和债权的担保。不要单独使用“security interest”（过于笼统）。区分“possessory pledge”（占有质，vuistpand）和“non-possessory pledge”（非占有质，stil pandrecht/bezitloos pandrecht）——后者是商业融资中的主导形式。
- **Hypotheek**：针对已登记财产（不动产、船舶、航空器）的抵押。英文翻译中切勿用“hypothec”（那是大陆法术语）。也不要将 hypotheek 译为“pledge”。
- **Parallel debt（平行债务）**：荷兰法担保交易的关键概念。荷兰法要求担保债权人同时是债权持有人（从属性），因此银团融资使用平行债务机制：每名贷款人的债权由担保代理人针对借款人的债权镜像对应，担保担保该平行债务。英文中保留“parallel debt”不译。
- **Bodemrecht / bodemvoorrecht**：荷兰税法特有的情况：荷兰税务署（Belastingdienst）对债务人场所内的“bodem-goederen”（底层资产，即债务人场所内存在的动产）享有法定留置权，可凌驾于非占有质之上。译为“bottom right”或“bottom privilege”并加注说明；外国读者需要这一警示。
- **Bank mortgage / bankhypotheek**：荷兰市场标准做法——抵押担保银行对债务人的一切现有和未来债权，而非仅某一笔特定贷款。首次使用时注明。
- **Notariële akte**：公证文书——抵押必需，（可选但通常）非占有质建议使用。在荷兰，这是在大陆法公证人面前签署的文书。不要与美国式公证（仅见证）混淆。
- **Verzuim / ingebrekestelling**：荷兰法要求发出正式的违约通知（ingebrekestelling）才能令债务人构成迟延履行（verzuim），之后某些救济（损害赔偿、解除）才可用。合同常放弃这一要求——翻译中保留（“without prior notice of default”，无须事先违约通知）。《荷兰民法典》第 6:82 条。
- **DNB 与 AFM**：荷兰“双峰”模式——DNB 是审慎监管机构，AFM 是行为监管机构。首次提及两者均拼写完整：De Nederlandsche Bank (DNB) 和 Autoriteit Financiële Markten (AFM)。
- **Wft 术语**：《金融监管法》（Wet op het financieel toezicht）是荷兰对 CRD/CRR、MiFID、偿付能力及其他欧盟指令的国内实施总框架。“Financial Supervision Act”是官方译名；保留“Wft”作为简称。
- **Zorgplicht**：荷兰银行和金融顾问负有的注意义务可能超出合同法要求。在著名的荷兰最高法院判例中，这被称为“bijzondere zorgplicht”（特别注意义务）。译为“duty of care”，将“special/enhanced duty of care”保留给判例法原则。
- **Achterstelling 与 subordinatie**：荷兰语用“achterstelling”表示从属；subordinatie 很少用。两者均译为“subordination”。
- **WHOA**：荷兰 2021 年《庭外重组方案确认法》（Dutch Scheme Act）——使用“WHOA”或“Dutch Scheme”，首次提及附全称。不要译为“Act on Confirmation of Private Composition”（过于直译）。与英国 scheme of arrangement 和美国破产法第 11 章 cramdown 类似。
- **Surseance van betaling**：荷兰历史上的停付程序。技术上仍然有效，但实务中大部分被 WHOA 取代。译为“suspension of payments”或“moratorium”。
- **Separatist**：在荷兰破产中，指可以“如同不存在破产一样”执行的担保债权人（质权人/抵押权人）——切勿译为“separatist”（英文中具有政治含义）。首次使用时用“separatist creditor”并加注，或描述为“secured creditor with independent enforcement rights”（享有独立执行权的担保债权人）。
- **“Verklaringen en garanties”**：源自英文“representations and warranties”的仿译。直接译为“representations and warranties”。不要用“declarations and guarantees”（会产生误导——“guarantee”具有特定的信用支持含义）。
- **“Opeisbaar”**：到期应付（且可依要求执行）。区别于仅仅是“due”（到期）——opeisbaarheid 触发加速到期权利。
- **“Jegens” 与 “tegenover”**：两者均意为“朝向/对”——jegens 的语域更正式/法律化。根据语境均译为“to”或“towards”。
- **“Rentevast” 与 “vaste rente”**：rentevast = 利率锁定期间（特定计息期）；vaste rente = 固定利率（相对于浮动利率）。翻译时须区别。
- **比利时荷兰语金融文件**：使用比利时民法典和经济法法典的条文引用；比利时质押法经 2013 年《质押法》（2018 年生效）大幅改革。主要差异：比利时动产质押可在国家质押登记簿登记；抵押法与荷兰结构类似，但具有比利时特定的优先权规则。比利时文件须标记交叉复核。

---

## 交易与资本市场 —— 荷兰语

根据翻译经验自动生成。将荷兰语交易、资本市场、证券和上市公司术语映射为正确的英文对应词。荷兰资本市场法以《金融监管法》（Wft）、欧盟法规（MiFID II/MiFIR、《招股说明书条例》、MAR、CSDR、EMIR、SFDR、SFTR、CSRD）以及《荷兰民法典》第二编第 9 章（年度账目）和第 8 章（大公司治理）为依据。
...
| gereglementeerde markt | regulated market | MiFID II —— 泛欧交易所阿姆斯特丹 |
| multilateral trading facility (MTF) | multilateral trading facility | |
| organized trading facility (OTF) | organized trading facility | |
...
| beleggingsonderneming | investment firm | 受 MiFID 监管的主体 |
...
| effectenafwikkelsysteem | settlement system | 受 CSDR 监管 |
...
| vergunning | license / authorization | |
| Wft-vergunning | Wft authorization | |
| MiFID-vergunning | MiFID authorization | |
| paspoort-regeling | passporting regime | 欧盟跨境业务 |
| branche | branch | |
...
| geschiktheid / passendheid | suitability / appropriateness | MiFID II 适当性 vs 适配性 |
| execution-only | execution-only | |
| niet-complexe instrumenten | non-complex instruments | |
| complex product | complex product | |
| provisieverbod | ban on commissions / inducements | Wft 第 86b 条及以下——全面禁止产品提供方的佣金 |
...
| cliëntcategorisatie | client categorization | |
...
| stabilisatieperiode | stabilization period | 欧盟委员会授权条例 2016/1052 |
...
| passporting van prospectus | prospectus passporting | 在欧洲经济区范围内 |
...
| managerstransacties | managers' transactions | 高管人员（PDMR）交易 |
| closed periods | closed periods | 业绩公告前后 |
...
| verplicht bod | mandatory offer | 表决权控制达 30% 时触发 |
...
| squeeze-out | squeeze-out | 《荷兰民法典》第 2:92a 条（公司）／第 2:359c 条（与要约相关） |
| sell-out | sell-out right | 少数股东在收购达 95% 时强制卖出权 |
| biedprocedure | offer procedure | |
| gestanddoening | declaration unconditional | 要约变为有约束力 |
...
| 荷兰语 | 英语 | 备注 |
|---|---|---|
| Corporate Governance Code / Nederlandse Corporate Governance Code | Dutch Corporate Governance Code | “适用或解释”；由监督委员会（Monitoring Commissie）监督 |
...
| beloningsbeleid | remuneration policy | 具有约束力的表决；SRD II |
...
| registratiedatum | record date | 会议前 28 天（《荷兰民法典》第 2:119 条） |
| agenderingsrecht | right to add agenda items | 持有 BV/NV 股份 3% 的门槛 |
| enquêterecht | right to inquiry proceedings | 《荷兰民法典》第 2:344 条及以下——向企业分庭（Ondernemingskamer）提起 |
| wanbeleid | mismanagement | 调查救济的检验标准 |
| onmiddellijke voorzieningen | immediate provisions | 企业分庭可施加 |
| proxy-solicitation | proxy solicitation | |
| stemadviesbureaus (ISS, Glass Lewis) | proxy advisers | |
| shareholder engagement | shareholder engagement | SRD II 的推动因素 |
| aandeelhoudersactivisme | shareholder activism | |
| 203 / responsetijd | response time | 《荷兰公司治理准则》——最长 180 天 |
| Stichting Continuïteit / preferred-share foundation | continuity foundation | 荷兰反收购装置 |
...
| prioriteitsaandelen | priority shares | 增强表决/治理权利 |
...
| meldingsplicht short position | short selling notification | 0.1% 门槛 |
| ongedekte short sale | uncovered short sale | |
| locate rule | locate rule | |
| substantial holding notification / Wft-melding | substantial holding notification | 门槛：3%、5%、10%、15%、20%、25%、30%、40%、50%、60%、75%、95%（民法典／Wft） |
| Wet melding zeggenschap | (historic) Significant Control Notification Act | 现已并入 Wft |
| SFTR | SFTR | 证券融资交易条例 |
| SFDR | SFDR | 可持续金融披露条例 |
| CSRD / ESRS | CSRD / ESRS | 企业可持续性报告 |
...
| tokenisatie | tokenization | |
| witwasrisico crypto | AML risk in crypto | |

## 译者注意事项

- **双峰模式（Twin-peaks model）**：荷兰自 2002 年以来的监管架构——DNB = 审慎监管（资本、偿付能力、治理）；AFM = 行为监管（分销、披露、市场诚信）。两者构成“双峰”——除英国/澳大利亚外独一无二。将“Autoriteit Financiële Markten”译为“Authority for the Financial Markets”或“AFM”；将“De Nederlandsche Bank”译为“Dutch Central Bank”或“DNB”。
- **Wft（《金融监管法》）**：荷兰全面的金融服务监管法规。涵盖银行、保险、投资公司、基金、招股说明书、收购、市场滥用。译为“Financial Supervision Act”；频繁使用时保留“Wft”并加注。
- **重大持股通知（Substantial holding notifications）**：荷兰门槛——3%、5%、10%、15%、20%、25%、30%、40%、50%、60%、75%、95%。通知 AFM 和发行人。是欧盟较严格的制度之一（许多成员国仅使用部分门槛）。对并购和积极投资者至关重要。
- **30% 强制要约门槛**：荷兰强制要约在拥有 30% 表决权时触发（与某些其他法域并列为欧盟最低）。将“Verplicht bod”一致译为“mandatory offer”，如受众不熟悉则标注 30% 门槛。
- **Stichting Continuïteit / 优先股基金会**：荷兰独特的反收购装置。基金会持有收购优先股的期权，稀释敌意收购方的表决权。ASML、KPN、DSM、飞利浦等均使用。译为“continuity foundation”或“protective foundation”；首次使用时保留“Stichting Continuïteit”并加注。
- **STAK / Stichting Administratiekantoor**：信托办公基金会——持有股份并发行存托凭证（“certificaten”）。常见于私人并购架构、家族企业、上市公司收购防御。凭证持有人可能有也可能没有会议权利。译为“trust-office foundation”并加注。
- **Enquêteprocedure / Ondernemingskamer**：荷兰独特的股东救济。少数股东（通常持股 10% 以上或上市公司市值 2 亿欧元以上）可请求企业分庭对公司事务展开调查。如认定“wanbeleid”（管理不善），企业分庭可施加影响深远的措施。常被策略性地用于并购争议（Fortis、荷兰银行、Delta Lloyd、联合利华）。译为“inquiry proceedings”或“enquête proceedings”并加注。
- **《荷兰公司治理准则》**：针对荷兰上市公司 NV 的“适用或解释”准则。2022 年更新——新增可持续性、多样性、文化条款。由监督委员会监督。译为“Dutch Corporate Governance Code”；标注版本日期。
- **《荷兰公司治理准则》响应时间**：有争议的荷兰概念。准则允许董事会对股东的重大战略提案有 180 天的响应时间。由股东积极主义推动。译为“response time”并加注。
- **Provisieverbod**：荷兰禁止产品提供方向投资公司/顾问/抵押贷款经纪人支付佣金（自 2013 年起，范围广于 MiFID II 的诱因制度）。涵盖大多数零售金融产品。译为“commission ban”／“ban on inducements”。
- **SER Fusiegedragsregels**：社会与经济理事会并购准则——要求并购中与工会和劳资委员会协商的程序规则。非法定但具有准约束力。译为“SER Merger Code”。
- **MAR（《市场滥用条例》）**：直接适用的欧盟条例。荷兰语与英语适用范围相同。保留“MAR”缩写；将“Marktmisbruikverordening”译为“Market Abuse Regulation”。
- **Biedingsbericht 与 offer memorandum**：根据 BOB（Wft 公开要约决定）对泛欧交易所阿姆斯特丹上市公司公开要约要求提交的要约备忘录。需经 AFM 批准。译为“offer memorandum”（英文标准市场用法）。
- **Gestanddoening**：要约人宣布要约无条件（最低接受条件及其他条件已满足）时——不可撤销的承诺。译为“declaration unconditional”或“wholly unconditional declaration”；首次使用为法律精确起见保留荷兰语。
- **荷兰强制挤出框架（Squeeze-out）**：两条路径——（1）《荷兰民法典》第 2:92a 条公司挤出：任何股东持股 95% 即可；（2）《荷兰民法典》第 2:359c 条与收购相关的挤出：公开要约后持股 95%（更短、更简化）。在企业分庭前适用不同程序。译为“squeeze-out”，并注明适用的民法典条文。
- **单层与双层董事会**：荷兰上市公司可任选其一。双层（传统）= 独立的管理委员会（RvB）和监事会（RvC）。单层（自 2013 年起）= 单一董事会，包含执行和非执行董事。适用不同规则（尤其在利益冲突方面）。翻译中始终指明结构。
- **Structuurregime / 结构制度**：达到门槛（净资产 1,600 万欧元以上、有劳资委员会、100 名以上荷兰雇员）的 NV 公司强制适用的大公司治理。监事会任命权从股东大会（GMS）转为自行补选；劳资委员会有约束力的提名。荷兰独特制度。译为“structure regime”／“large company regime”并加注。
- **Certain funds（确定资金）**：荷兰公开要约中使用的英文术语——投标人必须在宣布前证明已承诺资金。译为“certain funds”；保留英文。
- **Break fee / reverse break fee（分手费／反向分手费）**：荷兰私有化交易中常见。受荷兰判例法限制（不得超过合理的交易成本／损害）。AFM 将其作为抑制竞争性要约的潜在因素加以审查。译为“break fee”／“reverse break fee”。
- **投资公司的 Wwft 义务**：广泛的反洗钱/CDD 义务。咨询和执行服务中的关键触发点。译为“AML obligations”／“Wwft obligations”；频繁使用时保留 Wwft。
- **CSRD / ESRS / SFDR / Taxonomy**：欧盟可持续性报告框架，现对荷兰上市公司影响深远。欧盟文书的名称直译；保留缩写。
- **MiCA（2023/1114）**：适用于加密资产发行人/服务提供者；2024-2025 年分阶段适用。AFM/DNB 为荷兰主管当局。译为“MiCA”／“Markets in Crypto-Assets Regulation”。
- **比利时资本市场**：比利时上市公司（泛欧交易所布鲁塞尔）受《比利时公司与协会法典》和 FSMA（行为）／NBB（审慎）监管。比利时收购门槛不同（视情况为 30% 或 50%）。比利时《2020 年公司治理准则》采用类似的“适用或解释”方式。比利时文件须标记交叉复核。
- **Certificaten / 存托凭证**：荷兰独特的工具。经济权利和治理权利分离。凭证持有人享有经济权利；STAK 持有法定所有权并行使表决。每次提到存托凭证都须仔细标记。
- **Priority shares / prioriteitsaandelen**：具有增强权利（有约束力的提名、对特定决议的否决权）的特殊股份。曾普遍使用，自《荷兰公司治理准则》不鼓励后已罕见。在较旧结构中仍相关。译为“priority shares”。
