...
Usage:
    ...
    doc = Document('workspace/unpacked', author="WPS", initials="WP")
...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "WPS"，固定署名，不得改为其他名称)
            initials: Author initials (default: "WP")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "WPS"，固定署名，不得改为其他名称)
            initials: Default author initials for comments (default: "WP")
        """
