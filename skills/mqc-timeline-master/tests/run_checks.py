...
def main_render_guards():
    ...
    _lt = "某某大学某某某分校与某某某某某某教育科技有限公司买卖合同纠纷双方主张对读时间轴"
    ...
    try:
        ...
        _pm2["title_text"] = ("某某大学某某某分校与某某某某某某教育科技有限公司"
                              "买卖合同纠纷双方主张对读时间轴")
        _pd = _tf3.mkdtemp()
...
def main():
    ...
    PROBES = [
        ...
        ("岁岁平安公司", True), ("朗月大酒店", True),
        ("恒岳实业集团", True), ("明衡律师事务所", True),
        ("丙公司为恒岳实业集团", True),   # 前一句的占位符不得掩护后面的真名
        ("原告甲学院与被告乙公司", False),
    ]
    probe_fail = 0
