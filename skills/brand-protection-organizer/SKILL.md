---
name: brand-protection-organizer
slug: brand-protection-organizer
version: 1.0.2
displayName: "品牌仿冒投诉与下架｜简诗 AI"
summary: "发现并处理假网站、钓鱼站、商标侵权和抢注域名，整理证据、举报路径与预防动作，降低品牌和客户损失。"
description: "发现并处理假网站、钓鱼站、商标侵权和抢注域名，整理证据、举报路径与预防动作，降低品牌和客户损失。"
